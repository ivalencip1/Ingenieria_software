"""
Django settings for magboost project.
...
SECRET_KEY = 'django-insecure-s$w6-hvv=^58ztj=o3(6=#iy57j!a8^41s)861187jw1sty!!!'
...
WSGI_APPLICATION = 'magboost.wsgi.application'
